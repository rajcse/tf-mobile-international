...
},{"./actions/tfActions":1,"./components/Account":3,"./components/Dashboard":4,"./components/Header":5,"./components/Login":6,"./components/Navigation":7,"./components/Report":9,"./components/Search":11,"./components/Support":13,"./config":14,"./stores/resultsStore":17,"./stores/userStore":18,"lodash":"lodash","react":"react","react-dom":"react-dom","react-router":74}],3:[function(require,module,exports){
...
},{"../actions/tfActions":1,"../config.js":14,"lodash":"lodash","react":"react"}],4:[function(require,module,exports){
...
},{"../actions/tfActions":1,"../config.js":14,"lodash":"lodash","react":"react"}],7:[function(require,module,exports){
...
},{"../actions/tfActions":1,"../config.js":14,"../stores/reportStore":16,"lodash":"lodash","react":"react","react-router":74}],10:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]={API_ROOT:"http://www.api.truthfinder.app.public-records.local.tcg.io",themeStyles:{brandBlue:"#209DD2",brandGreen:"#57bf93",brandYellow:"#ffd20a",brandBlack:"#3e3e3e",brandWhite:"#fff",brandGray:"#e1e1e1",brandSlate:"#607d8b"},constants:{actions:{SEARCH:"SEARCH",UPDATE_CRITERIA:"UPDATE_CRITERIA",FETCH_REPORT:"FETCH_REPORT",LOGIN:"LOGIN",LOGOUT:"LOGOUT"},reportTypes:{PERSON:"people",PHONE:"phones",LOCATION:"locations"}}};
...
},{"../config.js":14,"../dispatcher":15,"../testPerson":19,"es6-promise":23,"events":"events","isomorphic-fetch":42,"lodash":"lodash"}],17:[function(require,module,exports){
...
},{"../config.js":14,"../dispatcher":15,"es6-promise":23,"events":"events","isomorphic-fetch":42,"lodash":"lodash"}],18:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function serialize(e,t){var r=[];for(var n in e)if(e.hasOwnProperty(n)){var o=t?t+"["+n+"]":n,i=e[n];r.push("object"==("undefined"==typeof i?"undefined":_typeof(i))?serialize(i,o):encodeURIComponent(o)+"="+encodeURIComponent(i))}return r.join("&")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_events=require("events"),_config=require("../config.js"),_config2=_interopRequireDefault(_config),_lodash=require("lodash"),_lodash2=_interopRequireDefault(_lodash),_dispatcher=require("../dispatcher"),_dispatcher2=_interopRequireDefault(_dispatcher);require("isomorphic-fetch"),require("es6-promise").polyfill();var CHANGE_EVENT="change",constants=_config2["default"].constants,_user=null,_errors=null,localUser=window.localStorage.getItem("user");if(localUser)try{_user=JSON.parse(localUser)}catch(e){}var UserStore=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,Object.getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"getUser",value:function(){return _user}},{key:"isLoggedIn",value:function(){return null!==_user}},{key:"emitChange",value:function(){this.emit(CHANGE_EVENT)}},{key:"addChangeListener",value:function(e){this.on(CHANGE_EVENT,e)}},{key:"removeChangeListener",value:function(e){this.removeListener(CHANGE_EVENT,e)}},{key:"login",value:function(e){var t=this;fetch(_config2["default"].API_ROOT+"/login",{headers:{"Content-Type":"application/x-www-form-urlencoded"},method:"POST",body:serialize(e)}).then(function(e){if("application/json"!==e.headers.get("Content-Type")){var t=new Error(e.statusText);throw t.response=e,t}return e}).then(function(e){return e.json()}).then(function(e){e.success?(_user=e.user,window.localStorage.setItem("user",JSON.stringify(_user))):_errors=e.errors,t.emitChange()})["catch"](function(e){console.error(e)})}},{key:"logout",value:function(){_user=null,_errors=null,window.localStorage.removeItem("user"),this.emitChange()}}]),t}(_events.EventEmitter),userStore=new UserStore;_dispatcher2["default"].register(function(e){switch(e.actionType){case constants.actions.LOGIN:userStore.login(e.credentials);break;case constants.actions.LOGOUT:userStore.logout()}}),exports["default"]=userStore;
