...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function serialize(e,t){var n=[];for(var r in e)if(e.hasOwnProperty(r)){var o=t?t+"["+r+"]":r,i=e[r];n.push("object"==("undefined"==typeof i?"undefined":_typeof(i))?serialize(i,o):encodeURIComponent(o)+"="+encodeURIComponent(i))}return n.join("&")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_events=require("events"),_config=require("../config.js"),_config2=_interopRequireDefault(_config),_lodash=require("lodash"),_lodash2=_interopRequireDefault(_lodash),_dispatcher=require("../dispatcher"),_dispatcher2=_interopRequireDefault(_dispatcher);require("isomorphic-fetch"),require("es6-promise").polyfill();var CHANGE_EVENT="change",constants=_config2["default"].constants,_jwt=null,_user=null,_errors=null,UserStore=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,Object.getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"getJWT",value:function(){return _jwt}},{key:"getUser",value:function(){return _user}},{key:"emitChange",value:function(){this.emit(CHANGE_EVENT)}},{key:"addChangeListener",value:function(e){this.on(CHANGE_EVENT,e)}},{key:"removeChangeListener",value:function(e){this.removeListener(CHANGE_EVENT,e)}},{key:"login",value:function(e){var t=this;fetch(_config2["default"].API_ROOT+"/login",{headers:{"Content-Type":"application/x-www-form-urlencoded"},method:"POST",body:serialize(e)}).then(function(e){if("application/json"!==e.headers.get("Content-Type")){var t=new Error(e.statusText);throw t.response=e,t}return e}).then(function(e){return e.json()}).then(function(e){e.success?(_jwt=e.jwt,_user=e.user,localStorage.setItem("user",e.user)):(_jwt=null,_user=null,_errors=e.errors),t.emitChange()})["catch"](function(e){console.error(e)})}}]),t}(_events.EventEmitter),userStore=new UserStore;_dispatcher2["default"].register(function(e){switch(e.actionType){case constants.actions.LOGIN:userStore.login(e.credentials)}}),exports["default"]=userStore;
