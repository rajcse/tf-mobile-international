...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_config=require("../config.js"),_config2=_interopRequireDefault(_config),_pubRecConstants=require("../constants/pubRecConstants"),_pubRecConstants2=_interopRequireDefault(_pubRecConstants),_lodash=require("lodash"),_lodash2=_interopRequireDefault(_lodash),_react=require("react"),_react2=_interopRequireDefault(_react),_viewActions=require("../actions/viewActions"),_viewActions2=_interopRequireDefault(_viewActions),TeaserLink=function(e){function t(e){_classCallCheck(this,t);var r=_possibleConstructorReturn(this,Object.getPrototypeOf(t).call(this,e));return r.selectTeaser=r.selectTeaser.bind(r),r}return _inherits(t,e),_createClass(t,[{key:"createPersonRecord",value:function(){var e=this.props.person,t={pointer:e["@search_pointer"],lexis_id:e["@id"],name:{first:null,last:null,middle:null,raw:null,suffix:null,type:null},location:{address:{street:null,street2:null,city:null,state:null,zip_code:null}},dobs:{date:null,date_range:null},dods:{date:null,date_range:null}};return e.names&&(t.name={first:e.names[0].first,last:e.names[0].last,middle:e.names[0].middle,raw:e.names[0].raw,suffix:e.names[0].suffix,type:e.names[0].type}),e.locations&&(t.location.address={street:e.locations[0].address.street,street2:e.locations[0].address.street2,city:e.locations[0].address.city,state:e.locations[0].address.state,zip_code:e.locations[0].address.zip_code}),e.dobs&&(t.dobs={date:e.dobs[0].date,date_range:e.dobs[0].date_range}),e.dods&&(t.dods={date:e.dods[0].date,date_range:e.dods[0].date_range}),t}},{key:"selectTeaser",value:function(){var e=void 0;switch(this.props.reportType){case _pubRecConstants2["default"].reportTypes.PERSON:e=this.createPersonRecord()}_viewActions2["default"].addRecord(e,this.props.reportType,!0)}},{key:"render",value:function(){return _react2["default"].createElement("button",{onClick:this.selectTeaser},this.props.buttonText)}}]),t}(_react.Component);exports["default"]=TeaserLink;var styles={};
