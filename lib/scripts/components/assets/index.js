						...
						<div className="subgroup">
							<h3>Transaction Information</h3>
								<div>
									...
									{ _.get(asset, 'assessment.sales_price') ?
										<SimpleRow
									...
									{ _.get(asset, 'assessment.sales_price') && _.get(asset, 'deed.first_td_loan_amount') ?
										<SimpleRow
											content={'$' + (Number.parseInt(asset.assessment.sales_price) - Number.parseInt(asset.deed.first_td_loan_amount))}
											title="Down Payment"
										/> : null
									}
									...
									{ _.get(asset, 'deed.first_td_loan_amount') ?
										<SimpleRow
											content={'$' + asset.deed.first_td_loan_amount}
