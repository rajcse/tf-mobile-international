		...
		return (
			<div>
				...
				{this.state.purchaseErrors ?
					<ErrorPrompt
						message={this.state.purchaseErrors == "Report Not Found" 
							? "Report Not Found. Dont worry we haven't charged you..." 
							: "An error occured while making your purchase. Please try again later"}
