							...
							<li key={i}>
								...
								{ _.has(associate,'dobs[0].date.month') ?
									<div>
										...
										<div className="content">
											<p>{constants.months[associate.dobs[0].date.month] + ', ' + associate.dobs[0].date.day + ' ' + associate.dobs[0].date.year}</p>
										</div>
									</div>
								: null }
								...
								{ _.has(associate,'date_last_cohabit.date_range.end.month') ?
									<div>
										...
										<div className="content">
											<p>{constants.months[associate.date_last_cohabit.date_range.end.month] + ', ' + associate.date_last_cohabit.date_range.end.day + ' ' + associate.date_last_cohabit.date_range.end.year}</p>
										</div>
									</div>
								: null }
