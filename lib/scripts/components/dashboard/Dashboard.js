		...
		return (
			<div id="dashboard">
				...
				<div id="record-filter">
					<select id="dashboard-filter" defaultValue={'ALL'} onChange={this.handleFilterChange}>
						<option value="All" value="All">Filter By ALL REPORTS</option>
						<option value={constants.recordTypes.PERSON}>Filter By PERSON REPORTS</option>
						<option value={constants.recordTypes.PHONE}>Filter By PHONE REPORTS</option>
						<option value={constants.recordTypes.EMAIL}>Filter By EMAIL REPORTS</option>
					</select>
				</div>
