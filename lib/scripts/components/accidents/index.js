			...
			<div className='multi-container'>
				<section id='accidents' className='widget multi-widget'>
					...
					{ _.has(vehicle, 'driver.driver_license.license_state') ?
						<SimpleRow
							key={`driver_license.license_state-${uuid.v1()}`}
