...
export default class Record extends React.Component {
	...
	render() {
		...
		if(this.state.offender.open) {
			return (
				<OffenderModal closeOffender={this.toggleOffenderModal} />
			);
		}
		...
		if(this.state.location.open) {
			return (
				<LocationModal closeLocation={this.toggleLocationModal} openOffender={this.toggleOffenderModal} selected={this.state.location.selected} record={this.state.record}  />
			);
		}
