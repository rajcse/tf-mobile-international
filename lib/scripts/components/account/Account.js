	...
	render() {
		return (
			<div>
				...
				<p><SearchLink criteria={{type: constants.recordTypes.PERSON, query: {firstName: 'John', lastName: 'Doe', state: 'CA'}, text: 'John Doe'}}>Do a person search!</SearchLink></p>
				<p><SearchLink criteria={{type: constants.recordTypes.PHONE, query: {phone: '7148619593'}, text: '7148619593'}}>Do a phone search!</SearchLink></p>
				<p><SearchLink criteria={{type: constants.recordTypes.EMAIL, query: {email: 'kris.kibak@gmail.com'}, text: 'kris.kibak@gmail.com'}}>Do an email search!</SearchLink></p>
			</div>
		);
	}
};
