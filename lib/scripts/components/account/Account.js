		...
		return (
			<div id="account">
				...
				<div id="legal" className="content-block">
					<h3>Legal</h3>
					<h4><a href="#" onclick="window.open('https://www.truthfinder.com/privacy-policy', '_system');">Privacy Policy</a></h4>
					<h4><a href="#" onclick="window.open('https://www.truthfinder.com/terms-of-use', '_system');">Terms of Use</a></h4>
				</div>
			</div>
		);
	}
