	...
	return (
		<main>
			...
			>
				...
				{ isPremium ?
					<div>
						{ !record.reportData.associates ? null :
							<Associates
								associates={record.reportData.associates}
								calculateAge={libs.calculateAge}
							/>
						}
						{ !record.reportData.possible_student_records ? null :
							<StudentRecords
						...
						/>
						{ !record.reportData.imposters ? null :
							<Imposters
								imposters={record.reportData.imposters}
							/>
						}
						{ !record.reportData.ssn_info ? null :
							<SocialSecurity
								ssn={record.reportData.ssn_info}
							/>
						}
						{ !record.reportData.voter_registrations ? null :
							<VoterRegistrations
				...
				{ isPremium ?
					<div>
						{ !record.reportData.accidents ? null :
							<Accidents
								accidents={record.reportData.accidents}
							/>
						}

						{ !record.reportData.corporate_affiliations ? null :
							<Businesses
								businesses={record.reportData.corporate_affiliations}
							/>
						}

						{ !record.reportData.properties ? null :
							<Assets
								assets={record.reportData.properties}
							/>
						}
						{ !record.reportData.bankruptcies ? null :
							<Bankruptcies
								bankruptcies={record.reportData.bankruptcies}
							/>
						}
						{ !record.reportData.liens_judgments ? null :
							<Liens
								liens={record.reportData.liens_judgments}
							/>
						}
						{ !record.reportData.watercrafts ? null :
							<Watercrafts
