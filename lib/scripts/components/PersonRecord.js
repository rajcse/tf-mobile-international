	...
	return (
		<main>
			...
			>
				...
				{(_.get(record.reportData.controlled_substances) ||
					_.get(record.reportData.faa_licenses) ||
					_.get(record.reportData.hunting_fishing_licenses) ||
					_.get(record.reportData.professional_licenses) ||
					_.get(record.reportData.weapon_permits)) ?
						<Licenses
							name={record.reportData.names[0].first}
