...
class PersonRecord extends Component {
	...
	render() {
		...
		let birthday = _.has(record.reportData,'dobs[0].date') 
			? record.reportData.dobs[0].date 
			: _.has(record.reportData,'dobs[0].date_range.start')
				? record.reportData.dobs[0].date_range.start
				: null;

		//console.log(record.reportData.dods[0].date_range.start);
		let deathday = _.has(record.reportData,'dods[0].date') 
		...
		//console.log(record.reportData.dods);
