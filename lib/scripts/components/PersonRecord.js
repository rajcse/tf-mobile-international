...
class PersonRecord extends Component {
	...
	render() {
		...
		let deathday = _.has(record.reportData,'dods[0].date') ? record.reportData.dods[0].date : null;
		...
		return (
			<main>
				...
				{ isPremium !== true ?
					<section id="upsell" className="widget"><h2 onClick={ () => { this.popupPremiumUpsell(); } }  className="title" >
