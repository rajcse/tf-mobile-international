			...
			<section id="watercrafts" className="widget multi-widget">
				...
				{ watercrafts.map((watercraft, index) => (
					<div className="license widget" key={index}>
						...
						{ (_.has(watercraft, 'description.class')  && watercraft.description.class !== '' ) ?
							<SimpleRow
								key={`class-${uuid.v1()}`}
						...
						{ (_.has(watercraft, 'description.length')  && watercraft.description.length !== '' ) ?
							<SimpleRow
								key={`length-${uuid.v1()}`}
						...
						{ (_.has(watercraft, 'description.width')  && watercraft.description.width !== '' ) ?
							<SimpleRow
								key={`width-${uuid.v1()}`}
						...
						{ (_.has(watercraft, 'description.use')  && watercraft.description.use !== '' ) ?
							<SimpleRow
								key={`use-${uuid.v1()}`}
						...
						{ (_.has(watercraft, 'description.hull_number')  && watercraft.description.hull_number !== '' ) ?
							<SimpleRow
								key={`hull2-${uuid.v1()}`}
						...
						{ (_.has(watercraft, 'description.hull_type')  && watercraft.description.hull_type !== '' ) ?
							<SimpleRow
								key={`hull-${uuid.v1()}`}
						...
						{ (_.has(watercraft, 'description.propulsion')  && watercraft.description.propulsion !== '' ) ?
							<SimpleRow
						...
						{ (_.has(watercraft, 'description.fuel')  && watercraft.description.fuel !== '' ) ?
							<SimpleRow
								key={`Fuel-${uuid.v1()}`}
						...
						{ (_.has(watercraft, 'description.vessel_type')  && watercraft.description.vessel_type !== '' ) ?
							<SimpleRow
								key={`Fuel-${uuid.v1()}`}
