	...
	render() {
		...
		if (_.has(crime.case_filing_date, 'month')) {
			...
			bookingDate = <div>
				...
				<p>{moment({
					month: crime.case_filing_date.month - 1 /* Months are 0 indexed */ ,
					day: crime.case_filing_date.day,
					year: crime.case_filing_date.year
				}).format('LL')}</p>
			</div>;
		}
			...
			<div className='criminal row'>
				...
				<div className='row-content'>
					...
					<div className='criminal-details'>
						...
						<button
							onTouchTap={() => this.toggleCriminalDetails()}
