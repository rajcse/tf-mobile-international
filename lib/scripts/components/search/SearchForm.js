...
export default class SearchForm extends Component {
	...
	handleInputChange(e) {
		if(this.props.criteria.type === constants.reportTypes.PHONE) e.target.value = this.formatPhone(e.target.value);
