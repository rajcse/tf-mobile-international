...
export default class SearchForm extends Component {
	...
	doSearch(e) {
		...
		switch(this.props.criteria.type) {
			...
			default:
				if(!this.props.criteria[constants.reportTypes.PERSON].firstName || !this.props.criteria[constants.reportTypes.PERSON].lastName) return this.setState({error: 'Please enter a valid first and last name'});
				
				let firstName = this.props.criteria[constants.reportTypes.PERSON].firstName.trim(),
					middleInitial = this.props.criteria[constants.reportTypes.PERSON].middleInitial.trim(),
					lastName = this.props.criteria[constants.reportTypes.PERSON].lastName.trim();
				
				search.query = {firstName: firstName, middleInitial: middleInitial,lastName: lastName, state: this.props.criteria[constants.reportTypes.PERSON].state};
				break;
				...
				<div className="row">
					<div className="controls">
						...
						<input
							type="text"
							placeholder="John"
							value={this.props.criteria[constants.reportTypes.PERSON].firstName}
					...
					<div className="controls">
						...
						<input
							...
							placeholder="J"
							maxLength="1"
							value={this.props.criteria[constants.reportTypes.PERSON].middleInitial}
							onChange={this.handleInputChange}
							disabled={this.props.searching}
							name="middleInitial"
						/>
				...
				<div className="row">
					<div className="controls">
						...
						<input
							type="text"
							placeholder="Doe"
							value={this.props.criteria[constants.reportTypes.PERSON].lastName}
							onChange={this.handleInputChange}
							disabled={this.props.searching}
							name="lastName"
						/>
