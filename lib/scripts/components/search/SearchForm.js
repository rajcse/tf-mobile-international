	...
	doSearch(e) {
		...
		switch(this.props.criteria.type) {
			...
			default:
				...
				search.query = {firstName: firstName, middleInitial: middleInitial,lastName: lastName, state: this.props.criteria[constants.recordTypes.PERSON].state, city: this.props.criteria[constants.recordTypes.PERSON].city};
				break;
