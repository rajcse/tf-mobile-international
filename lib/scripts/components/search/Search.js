...
export default class Search extends React.Component {
	...
	render() {
		...
		if(search.searching) {
			...
			if ((search.criteria.type === constants.recordTypes.PERSON) && _.get(search,'criteria[constants.recordTypes.PERSON].lastName[0]') && _.get(search,'criteria[constants.recordTypes.PERSON].firstName[0]')) {
