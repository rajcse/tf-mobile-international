...
const PersonReport = (props) => {
	...
	return (
		<main>
			...
			<PersonalSectionView name={name.display} aliases={aliases} age={birthInfo} photos={photos} jobs={jobs} links={relatedLinks} education={education} />

			<ContactSectionView phones={phones} emails={emails} />

			<LocationSectionView data={locations} />
			
			<CriminalRecordsSectionView data={criminalRecords} />

			<SocialSectionView sources={socialProfiles} />

			<SexOffenderSectionView sources={sexOffenders} />
