...
export default class Report extends Component {
	...
	componentWillMount() {
		...
		viewActions.fetchReport({reportType: this.props.params.reportType, reportId: this.props.params.reportId, jwt: this.props.appState.user.jwt});
	}
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.params.reportType !== this.props.params.reportType || nextProps.params.reportId !== this.props.params.reportId) {
			...
			viewActions.fetchReport({reportType: nextProps.params.reportType, reportId: nextProps.params.reportId});
		}
	}
