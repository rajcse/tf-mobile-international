			...
			<main>
				...
				<div className="modal-tab">
					<OwlCarousel slideSpeed={300} itemsCustom={[[0,2], [375, 2]]} navigation={false} singleItem={false} autoPlay={false} >
						<div onTouchTap={this.switchSexTab} className={this.state.sex ? 'active' : null}>Sex Offenders</div>
						<div onTouchTap={this.switchCrimeTab} className={this.state.crime ? 'active' : null}>Crime Statistics</div>
					</OwlCarousel>
				</div>
