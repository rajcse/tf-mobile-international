...
class UserStore extends EventEmitter {
    ...
    addRecord(recordData, reportType, navigate) {
        
        fetch(config.API_ROOT + '/person?jwt=' + _user.jwt, {
                headers: {
            ...
            .then((responseData) => {
                if(responseData.success) {
                    console.log(responseData.recordId);
                    if(navigate) _navigateTo = '/' + reportType + '/' + responseData.recordId;
                } else {
...
dispatcher.register(function(action) {
    switch(action.actionType) {
        ...
        case constants.actions.ADD_RECORD:
            userStore.addRecord(action.recordData, action.reportType, action.navigate);
            break;
            
        case constants.actions.CLEAR_NAVIGATION:
            userStore.clearNavigation();
            break;
