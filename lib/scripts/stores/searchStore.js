...
function defaultResults() {
    ...
    for (let reportType in constants.reportTypes) {
        if (constants.reportTypes.hasOwnProperty(reportType))
            resultsSet[constants.reportTypes[reportType]] = null;
    }
...
function defaultCriteria() {
    ...
    // Person
    criteriaSet[constants.reportTypes.PERSON] = {
        firstName: '',
        middleInitial: '',
        lastName: '',
        state: 'ALL'
    ...
    // Phone
    criteriaSet[constants.reportTypes.PHONE] = {
        text: ''
    };
    
    // Email
    criteriaSet[constants.reportTypes.EMAIL] = {
        text: ''
    };
...
dispatcher.register(function(action) {
	...
	switch(action.actionType) {
        ...
        case constants.actions.GO_TO_SEARCH:
            ...
            _criteria[constants.reportTypes.PERSON].state = action.criteria.query.state ? action.criteria.query.state : _criteria.state;
            _searching = true;
            searchStore.emitChange();
            break;
