...
/**
 * Takes location report and merges it into the person report for the location with the provided pointer
 * This is due to a full location report possibly having a diferent pointer from the one provided for a person's locations
 */
