...
function mergeLocationData(location) {
	let locationIndex = _.findIndex(_report.locations, {'@search_pointer': location['@search_pointer']});
...
dispatcher.register(function(action) {
	...
	switch(action.actionType) {
		...
		case constants.actions.RECEIVE_LOCATION_TEASER:
			mergeLocationData(action.location)
			reportStore.emitChange();
			break;
