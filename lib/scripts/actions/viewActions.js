...
export default {
	...
	selectTeaser: function(recordData, reportType) {
		...
		pubRecAPI.createRecordAndRedirect(recordData, reportType);
	},
	
	// Use this to clear the report redirect and avoid infinitely redirecting
	// Done via view actions to remain fluxed up
	clearReportRedirect: function() {
		dispatcher.dispatch({
			actionType: constants.actions.CLEAR_REPORT_REDIRECT
		});
	},
