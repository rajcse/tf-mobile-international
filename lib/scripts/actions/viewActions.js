...
export default {
	...
	clearUserErrors: function(redirectToHome = false) {
		dispatcher.dispatch({
	...
	showPremiumUpsell: function(recordId) {
		dispatcher.dispatch({
	...
	confirmPremiumUpsell: function(recordId) {
		dispatcher.dispatch({
