...
export default {
	...
	reportLoaderTeasers : [
		...
		'Republican or democrat? Possible voter registration available in a premium report',
		'Scroll through possible business associations',
		'Possible associates — find people that your search subject may have shared a residential or business address with!',
		'Are they related to a criminal? Check out relatives reports when you upgrade to a premium report!',
		'Is that REALLY his boat? Or is it his parent’s? Find out if they own watercraft on a premium report!',
		'Is your blind date a Democrat? If you bleed red, you’ll want to check their voter registration on a premium report.',
		'Are you committed to the vegan lifestyle? Find out if your next date has a hunting license with a premium report!',
		'How many times has she filed for bankruptcy? The debt of your fiancee will soon be yours — get the truth with a premium report. ',
		...
		'Steer clear of financial losers with bankruptcy, lien, judgment, and foreclosure info in a premium report.',
		'13% of Americans own their own business. Discover business affiliations by upgrading to a premium report.',
		...
		'Pull a premium report on Donald Trump to find billions in real estate holdings, relatives, and a slew of recent lawsuits.',
		'Trying to find hidden assets in a divorce?  Premium reports may reveal a secret goldmine.',
		'Are they a four-year graduate … or a total liar? Find out where they really went to college with a premium report.',
		...
		'Are you related to any jailbirds? A premium report can reveal arrest records for family and known associates. Upgrade today!',
		'11.1 million Americans have permits to carry concealed weapons. Find out if they have a concealed weapons permit with a premium report!'
	]
};
