...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]={API_ROOT:"http://www.api.truthfinder.app.public-records.local.tcg.io",themeStyles:{brandBlue:"#209DD2",brandGreen:"#57bf93",brandYellow:"#ffd20a",brandBlack:"#3e3e3e",brandWhite:"#fff",brandGray:"#e1e1e1",brandSlate:"#607d8b"},constants:{actions:{SEARCH:"SEARCH",UPDATE_CRITERIA:"UPDATE_CRITERIA",FETCH_REPORT:"FETCH_REPORT",LOGIN:"LOGIN"},reportTypes:{PERSON:"people",PHONE:"phones",LOCATION:"locations"}}};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function serialize(e,t){var n=[];for(var o in e)if(e.hasOwnProperty(o)){var r=t?t+"["+o+"]":o,i=e[o];n.push("object"==("undefined"==typeof i?"undefined":_typeof(i))?serialize(i,r):encodeURIComponent(r)+"="+encodeURIComponent(i))}return n.join("&")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}(),_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_events=require("events"),_config=require("../config.js"),_config2=_interopRequireDefault(_config),_lodash=require("lodash"),_lodash2=_interopRequireDefault(_lodash),_dispatcher=require("../dispatcher"),_dispatcher2=_interopRequireDefault(_dispatcher);require("isomorphic-fetch"),require("es6-promise").polyfill();var CHANGE_EVENT="change",constants=_config2["default"].constants,_jwt=[],_credentials={},LoginStore=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,Object.getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"getJWT",value:function(){return _jwt}},{key:"emitChange",value:function(){this.emit(CHANGE_EVENT)}},{key:"addChangeListener",value:function(e){this.on(CHANGE_EVENT,e)}},{key:"removeChangeListener",value:function(e){this.removeListener(CHANGE_EVENT,e)}},{key:"fetchData",value:function(){fetch(_config2["default"].API_ROOT+"/login/?"+serialize(_credentials)).then(function(e){return e.json()}).then(function(e){_jwt=e.jwt,localStorage.setItem("customer",e),document.location.href="/"})["catch"](function(e){console.warn(e)})}}]),t}(_events.EventEmitter),loginStore=new LoginStore;_dispatcher2["default"].register(function(e){switch(e.actionType){case constants.actions.LOGIN:_credentials=e.credentials,loginStore.emitChange(),loginStore.fetchData()}}),exports["default"]=loginStore;

},{"../config.js":14,"../dispatcher":15,"es6-promise":23,"events":"events","isomorphic-fetch":42,"lodash":"lodash"}],17:[function(require,module,exports){
